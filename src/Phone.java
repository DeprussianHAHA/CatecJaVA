public class Phone {
    ...
    public Phone(String number, String model, String ownerName, String colorPhone, String recieverPhone, String weight,String memoryPhone,String heightPhone, String permissionPhone, String frequencyPhone,String screentypePhone) {
        this.number = number;
        this.model = model;
        this.ownerName = ownerName;
        this.colorPhone = colorPhone;
